...
namespace KnowCostData.Entity
{
    public class MongoConnectionHandler<T> where T : IMongoEntity
    {
        ...
        public MongoConnectionHandler(string Collection)
        {
            ...
            //const string connectionString = "mongodb://chatapp-mongo:0Ot0q1C69gy9JRxqgjxvddAljHL0IIVGPHGJ0wV7dsXLecytzeLOZ3alpKkWc3DWSy5I4L7wxA6ZB5XQkZorrg==@chatapp-mongo.documents.azure.com:10250/?ssl=true&sslverifycertificate=false";
